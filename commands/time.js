var commandName      = "time";
var commandSudo      = false;
var commandHelp      = "Show the time.";
var commandUsage     = "";
...
hook.on('common/runCommand', function (from, to, isAdmin, args, message) {
    ...
    common.botSay(target, common.mention(from) + "The current date and time right now is " + new Date(new Date().getTime()).toLocaleString());
});
